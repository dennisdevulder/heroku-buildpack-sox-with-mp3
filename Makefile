...
ACLOCAL = ${SHELL} /tmp/sox-14.4.1/missing --run aclocal-1.12
ALSA_CFLAGS = 
ALSA_LIBS = 
AMRNB_CFLAGS = 
AMRNB_LIBS = 
...
AR = ar
AS = 
AUTOCONF = ${SHELL} /tmp/sox-14.4.1/missing --run autoconf
AUTOHEADER = ${SHELL} /tmp/sox-14.4.1/missing --run autoheader
AUTOMAKE = ${SHELL} /tmp/sox-14.4.1/missing --run automake-1.12
AWK = mawk
CC = gcc
...
LTLIBOBJS = 
MAGIC_LIBS = 
MAKEINFO = ${SHELL} /tmp/sox-14.4.1/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MP3_CFLAGS = 
MP3_LIBS = 
...
WAVPACK_CFLAGS = 
WAVPACK_LIBS = 
abs_builddir = /tmp/sox-14.4.1
abs_srcdir = /tmp/sox-14.4.1
abs_top_builddir = /tmp/sox-14.4.1
abs_top_srcdir = /tmp/sox-14.4.1
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /tmp/sox-14.4.1/install-sh
