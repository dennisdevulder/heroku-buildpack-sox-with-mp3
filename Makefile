...
ACLOCAL = ${SHELL} /app/vendor/heroku-buildpack-sox-with-mp3/missing --run aclocal-1.12
ALSA_CFLAGS = 
ALSA_LIBS = 
AMRNB_CFLAGS = 
AMRNB_LIBS = 
...
AR = ar
AS = 
AUTOCONF = ${SHELL} /app/vendor/heroku-buildpack-sox-with-mp3/missing --run autoconf
AUTOHEADER = ${SHELL} /app/vendor/heroku-buildpack-sox-with-mp3/missing --run autoheader
AUTOMAKE = ${SHELL} /app/vendor/heroku-buildpack-sox-with-mp3/missing --run automake-1.12
AWK = mawk
CC = gcc
...
LTLIBOBJS = 
MAGIC_LIBS = 
MAKEINFO = ${SHELL} /app/vendor/heroku-buildpack-sox-with-mp3/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MP3_CFLAGS = 
MP3_LIBS = 
...
PACKAGE_NAME = SoX
PACKAGE_STRING = SoX 14.4.1
PACKAGE_TARNAME = sox
PACKAGE_URL = 
PACKAGE_VERSION = 14.4.1
PATH_SEPARATOR = :
...
WAVPACK_CFLAGS = 
WAVPACK_LIBS = 
abs_builddir = /app/vendor/heroku-buildpack-sox-with-mp3
abs_srcdir = /app/vendor/heroku-buildpack-sox-with-mp3
abs_top_builddir = /app/vendor/heroku-buildpack-sox-with-mp3
abs_top_srcdir = /app/vendor/heroku-buildpack-sox-with-mp3
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /app/vendor/heroku-buildpack-sox-with-mp3/install-sh
